...
} else if (currentPagePath === '/subpage/write.html' || currentPagePath === '/public/subpage/write.html') {
  addActiveClass(linkWrite);
} else if (currentPagePath === '/subpage/friend.html' || currentPagePath === '/public/subpage/friend.html') {
